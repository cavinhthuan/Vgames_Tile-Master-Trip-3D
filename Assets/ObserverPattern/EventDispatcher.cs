...
public class EventDispatcher : MonoBehaviour
{
    ...
    {
        // checking params
        Debug.Assert(callback != null, "AddListener, event {0}, callback = null !!\n" + eventID.ToString());
    ...
    {
        // checking params
        Debug.Assert(callback != null, "RemoveListener, event {0}, callback = null !! \n" + eventID.ToString());
...
public static class EventDispatcherExtension
{
    ...
    {
        if(EventID.NextLevel == eventID)
            EventDispatcher.ResponseCount++;
